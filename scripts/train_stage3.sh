...
python train.py --stage fusion --name coco_mask --sample_p 1.0 --niter 5 --niter_decay 0 --lr 0.00005 --model train --load_model --display_ncols 4 --fineSize 256 --batch_size 1 --display_freq 1 --print_freq 1 --train_img_dir $DATASET_DIR --no_html